...
NSString * const kZJTargetStr = @"ZJTargetS";
NSString * const kZJActionStr = @"ZJAction";
...
- (id)performTarget:(NSString *)targetName action:(NSString *)actionName params:(id)params shouldCacheTarget:(BOOL)shouldCacheTarget
{
    ...
    NSString *targetClassString = [NSString stringWithFormat:@"%@_%@",kZJTargetStr,targetName];
    NSString *actionString = [NSString stringWithFormat:@"%@_%@:",kZJActionStr,actionName];
    Class targetClass;
    ...
    if ([target respondsToSelector:action]) {
        ...
        // 有可能target是Swift对象
        actionString = [NSString stringWithFormat:@"%@_%@WithParams:",kZJActionStr,actionName];
