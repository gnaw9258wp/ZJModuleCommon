...
@implementation UIColor (ZJHEX)

+ (UIColor *)ZJ_colorWithHex:(UInt32)hex
{
    return [UIColor ZJ_colorWithHex:hex alpha:1];
}

+ (UIColor *)ZJ_colorWithHex:(UInt32)hex alpha:(CGFloat)alpha
{
...
+ (UIColor *)ZJ_colorWithHexString:(NSString *)rgbStr alpha:(CGFloat)alpha
{
    NSMutableString *colorString = [NSMutableString stringWithString:rgbStr];
    [colorString replaceCharactersInRange:[rgbStr rangeOfString:@"#"] withString:@"0x"];
    long rgb = strtoul([colorString cStringUsingEncoding:NSUTF8StringEncoding], 0, 16);
...
+ (UIColor *)ZJ_colorWithHexString:(NSString *)strHex
{
...
+ (UIColor *)ZJ_colorWithWholeRed:(CGFloat)red
                         green:(CGFloat)green
                          blue:(CGFloat)blue
{
    return [self ZJ_colorWithWholeRed:red
                             green:green
                              blue:blue
                             alpha:1.0];
}
